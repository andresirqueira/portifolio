/**
 * Ícones SVG para realizações — use as chaves em data.js (campo icon).
 */
const ACHIEVEMENT_ICONS = {
  ...
  network: `<circle cx="12" cy="12" r="2"/><path d="M16.24 7.76a6 6 0 0 1 0 8.49M7.76 7.76a6 6 0 0 0 0 8.49M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/>`,
  ...
  sparkles: `<path d="M12 3l1.2 3.6L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2z"/><path d="M5 3v3M3.5 4.5h3M19 17v3M17.5 18.5h3"/>`,
...
function renderAchievementIcon(name, className = "achievement-icon") {
  return renderIcon(name, className);
}

function renderIcon(name, className = "ui-icon") {
  const paths = ACHIEVEMENT_ICONS[name] || ACHIEVEMENT_ICONS.code;
